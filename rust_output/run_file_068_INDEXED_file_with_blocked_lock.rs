...
fn p_file1(state: &mut ProgramState) {
    if &format!("{}", state.fs) != &"00".to_string() {
    ...
    if &format!("{}", state.fs) != &"61".to_string() {
        println!("{}{}", "FAILED: ", state.fs);
        file1_close(state);
    }
    { let _ = state._fh_file1.close();
...
/// STUB: lock_open_input
fn lock_open_input(state: &mut ProgramState) {
    // TODO: stub for undefined paragraph lock_open_input
}

/// STUB: with_open_input
fn with_open_input(state: &mut ProgramState) {
    // TODO: stub for undefined paragraph with_open_input
}
