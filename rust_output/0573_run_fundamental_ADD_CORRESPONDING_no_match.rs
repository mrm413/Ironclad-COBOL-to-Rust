...
fn p__implicit_(state: &mut ProgramState) {
    { let _a: f64 = format!("{}", state.group_2).trim().parse().unwrap_or(0.0); let _b: f64 = format!("{}", state.corresponding).trim().parse().unwrap_or(0.0); state.group_2 = format!("{}", _a - _b).cobol_into(); }
    // FROM GROUP-1
