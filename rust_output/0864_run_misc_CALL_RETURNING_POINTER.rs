...
pub struct ProgramState {
    ...
    /// WS: C-TEXT-POINTER
    pub c_text_pointer: FixedString<1>,
    // --- Special registers ---
...
fn p__implicit_(state: &mut ProgramState) {
    // CALL 'STATIC' USING 
    // "cob_getenv" USING "COB_UNIX_LF" RETURNING C-TEXT-POINTER END-CALL IF FUNCTION CONTENT-OF(C-TEXT-POINTER) <> "1" DISPLAY "unexpected value: " FUNCTION CONTENT-OF(C-TEXT-POINTER)
    return;
}
