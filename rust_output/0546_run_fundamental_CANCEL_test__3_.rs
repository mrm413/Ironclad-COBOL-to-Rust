...
fn p__implicit_(state: &mut ProgramState) {
    println!("{}", format!("{}", state.var));
    { let _a: f64 = format!("{}", state.var).trim().parse().unwrap_or(0.0); let _b: f64 = format!("{}", 1).trim().parse().unwrap_or(0.0); state.var = format!("{}", _a + _b).cobol_into(); }
    return;
}
