...
fn p__implicit_(state: &mut ProgramState) {
    ...
    if format!("{}", state.g).trim() != format!("{}", "a3b2c5d4e1").trim() {
        println!("{}", format!("{}", state.g));
    }
    // SORT TBL DESCENDING KEY Y
    if format!("{}", state.g).trim() != format!("{}", "c5d4a3b2e1").trim() {
        println!("{}", format!("{}", state.g));
    }
    ...
    if format!("{}", state.g).trim() != format!("{}", "e1d4c5b2a3").trim() {
        println!("{}", format!("{}", state.g));
    }
    std::process::exit(0);
}
