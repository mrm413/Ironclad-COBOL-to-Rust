...
fn p__implicit_(state: &mut ProgramState) {
    state.return_code = format!("{}", " ").cobol_into();
    state.return_code = format!("{}", 0).cobol_into();
    state.return_code = format!("{}", 1).cobol_into();
    state.i = format!("{}", state.return_code).cobol_into();
    if format!("{}", state.i).trim() != format!("{}", 1).trim() {
        println!("{}", format!("{}", state.i));
    }
    std::process::exit(0);
}
