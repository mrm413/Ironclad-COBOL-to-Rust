...
fn p_main(state: &mut ProgramState) {
    state.main_var = "A".into();
    // SKIP: unresolved ref: state._unresolved_main = "B".into();
    // SKIP: unresolved ref: state._unresolved_repo_prog = "C".into();
    // SKIP: unresolved ref: state._unresolved_quote = "D".into();
    // AUTO-FIX SKIP: invalid LHS: "A".into() = "E".into();
    { std::process::exit(0); }
}
