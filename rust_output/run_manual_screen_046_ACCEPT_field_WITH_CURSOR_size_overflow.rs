...
fn p_testme(state: &mut ProgramState) {
    println!();
    println!("{}{}{}", "column in the field below, then position it at", 2, 1);
    println!("{}{}{}", "the 'C' (third column) and press ENTER.", 3, 1);
    state.ws_x_20 = "ABCDEFGHIJ".into();
    state.cur_pos = 12 as u32;
