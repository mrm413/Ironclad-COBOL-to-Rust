...
impl std::fmt::Display for Ptrs {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        write!(f, "{}{}{}{}", self.misalign_1, self.ptr, self.ptr_num, self.misalign_2)
    }
}
impl From<&str> for Ptrs {
    fn from(_s: &str) -> Self { Self::default() }
}
impl From<String> for Ptrs {
    fn from(_s: String) -> Self { Self::default() }
}
impl Ptrs {
    pub fn as_str(&self) -> String { format!("{}", self) }
...
impl Default for ProgramState {
    fn default() -> Self {
        Self {
            ...
            misalign_1: Default::default(),
            ptr: Default::default(),
            misalign_2: Default::default(),
            num: Default::default(),
            return_code: 0,
            tally: 0,
            sort_return: 0,
