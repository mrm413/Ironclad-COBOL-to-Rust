...
impl Default for ProgramState {
    fn default() -> Self {
        Self {
            p1: FixedString::from_cobol_str("A"),
            p2: FixedString::from_cobol_str("NOT OK"),
            return_code: 0,
            tally: 0,
            sort_return: 0,
            cob_crt_status: 0,
...
fn p_p2(state: &mut ProgramState) {
    state.p1 = "B".into();
    state.p2 = "OKOKOK".into();
    {
        let mut _p1 = (state.p1).clone();
        callee(&mut _p1);
        state.p1 = _p1;
    }
    { std::process::exit(0); }
...
fn callee(_param1: &mut impl std::fmt::Debug) {
