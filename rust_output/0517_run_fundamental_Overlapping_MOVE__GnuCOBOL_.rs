...
define_record! {
    ...
    pub struct Structure {
        /// FIELD1
        pub field1: FixedString<5>,
        /// FIELD2
        pub field2: FixedString<10>,
    }
}
...
fn p__implicit_(state: &mut ProgramState) {
    state.field1 = format!("{}", "Hallo").cobol_into();
    state.field2 = format!("{}", "1234567890").cobol_into();
    // CALL 'subprog' USING &mut state.field2, &mut state.structure
    std::process::exit(0);
}
