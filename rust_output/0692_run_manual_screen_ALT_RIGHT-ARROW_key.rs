...
fn p__implicit_(state: &mut ProgramState) {
    println!("{}", format!("{}", "Enter 'y' if pressing the ALT and RIGHT-ARROW keys"));
    println!("{}", format!("{}", "at the last column does not exit the field."));
    println!("{}", format!("{}", "But the RIGHT-ARROW without ALT does exit."));
