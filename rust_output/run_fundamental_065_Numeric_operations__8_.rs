...
impl std::fmt::Display for ComputeData {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        write!(f, "{}", self.compute_8)
    }
}
impl From<&str> for ComputeData {
    fn from(_s: &str) -> Self { Self::default() }
}
impl From<String> for ComputeData {
...
impl Default for ProgramState {
    fn default() -> Self {
        Self {
            compute_data: Default::default(),
            compute_8: Default::default(),
            return_code: 0,
            tally: 0,
            sort_return: 0,
            cob_crt_status: 0,
