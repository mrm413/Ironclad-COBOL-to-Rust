...
impl std::fmt::Display for Scr1 {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        write!(f, "{}{}{}{}{}{}{}{}", self.line, self.line_2, self.line_3, self.line_4, self.line_5, self.line_6, self.line_7, self.line_8)
    }
}
...
impl std::fmt::Display for Scr3 {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        write!(f, "{}{}", self.value, self.success_field)
    }
}
impl From<&str> for Scr3 {
    fn from(_s: &str) -> Self { Self::default() }
}
impl From<String> for Scr3 {
    fn from(_s: String) -> Self { Self::default() }
}
impl Scr3 {
    pub fn as_str(&self) -> String { format!("{}", self) }
