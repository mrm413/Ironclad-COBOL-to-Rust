...
fn p__implicit_(state: &mut ProgramState) {
    ...
    if format!("{}", state.dst1).trim() != format!("{}", 11.550000).trim() {
        println!("{}{}{}{}", format!("{}", "error 1: move/compare FLOAT-EXTENDED to FLOAT-SH "), format!("{}", state.ort), format!("{}", state.failed), format!("{}", " DST1 END-DISPLAY END-IF"));
    }
    state.dst2 = format!("{}", state.src1).cobol_into();
    if format!("{}", state.dst1).trim() != format!("{}", 11.550000).trim() {
        println!("{}{}{}{}", format!("{}", "error 2: move/compare FLOAT-EXTENDED to FLOAT-SH "), format!("{}", state.ort), format!("{}", state.failed), format!("{}", " DST2 END-DISPLAY END-IF"));
    }
    state.dst1 = format!("{}", 0).cobol_into();
    state.dst2 = format!("{}", 0).cobol_into();
    state.dst1 = format!("{}", state.src2).cobol_into();
    if format!("{}", state.dst1).trim() != format!("{}", 11.550000).trim() {
        println!("{}{}{}{}", format!("{}", "error 3: move/compare FLOAT-EXTENDED to FLOAT-SH "), format!("{}", state.ort), format!("{}", state.failed), format!("{}", " DST1 END-DISPLAY END-IF"));
    }
    state.dst2 = format!("{}", state.src2).cobol_into();
    if format!("{}", state.dst2).trim() != format!("{}", 11.550000).trim() {
        println!("{}{}{}{}", format!("{}", "error 4: move/compare FLOAT-EXTENDED to FLOAT-SH "), format!("{}", state.t), format!("{}", state.failed), format!("{}", " DST2 END-DISPLAY END-IF"));
    }
    state.dst1 = format!("{}", 0).cobol_into();
