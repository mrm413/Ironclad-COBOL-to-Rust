...
pub struct Imphead {
    /// IMPPIC
    pub imppic: FixedString<1>,
}
impl std::fmt::Display for Imphead {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        write!(f, "{}", self.imppic)
    }
}
impl From<&str> for Imphead {
    fn from(_s: &str) -> Self { Self::default() }
}
impl From<String> for Imphead {
...
impl Default for ProgramState {
    fn default() -> Self {
        Self {
            imphead: Default::default(),
            imppic: Default::default(),
            return_code: 0,
            tally: 0,
            sort_return: 0,
            cob_crt_status: 0,
