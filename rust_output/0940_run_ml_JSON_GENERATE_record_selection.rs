...
fn p__implicit_(state: &mut ProgramState) {
    // *> JSON GENERATE OUT FROM A *> IF OUT <> '<a><b><c1>abc</c1><c2>0</c2></b><f>f</f><f>f</f *> ' <f>f</f></a>' *> DISPLAY "Failed 1: " FUNCTION TRIM (OUT) *> END-IF JSON GENERATE OUT FROM D IF OUT <> ' {"d" :{"e" :"abc000" }}' DISPLAY "Failed 2: " FUNCTION TRIM (OUT) END-IF 
    // END PROGRAM PROG
}
