...
fn p__implicit_(state: &mut ProgramState) {
    if format!("{}", state.x_x).trim() != format!("{}", state.x_9).trim() {
        println!("{}", format!("{}", "NG X-X <> X-9"));
    }
    if format!("{}", state.x_9).trim() != format!("{}", state.x_x).trim() {
        println!("{}", format!("{}", "NG X-9 <> X-X"));
    }
    std::process::exit(0);
}
