...
fn p__implicit_(state: &mut ProgramState) {
    if { let __v = format!("{}", state.swit1_on); __v.trim() != "" && __v.trim() != "0" } {
        println!("{}", format!("{}", "ON"));
    } else {
        println!("{}", format!("{}", "OFF"));
    }
    if { let __v = format!("{}", state.swit2_on); __v.trim() != "" && __v.trim() != "0" } {
        println!("{}", format!("{}", " ON"));
    } else {
        println!("{}", format!("{}", " OFF"));
    }
    if { let __v = format!("{}", state.swit3_on); __v.trim() != "" && __v.trim() != "0" } {
        println!("{}", format!("{}", " ON"));
    } else {
        println!("{}", format!("{}", " OFF"));
    }
    ...
    state.swit1 = " ".to_string().cobol_into();
    state.swit2 = " ".to_string().cobol_into();
    if { let __v = format!("{}", state.swit1_on); __v.trim() != "" && __v.trim() != "0" } {
        println!("{}", format!("{}", " ON"));
    } else {
        println!("{}", format!("{}", " OFF"));
    ...
    if { let __v = format!("{}", state.swit31_on); __v.trim() != "" && __v.trim() != "0" } {
        println!("{}", format!("{}", " ON"));
    } else {
        println!("{}", format!("{}", " OFF"));
    }
