...
pub struct Scr {
    /// FULL-POINTLESS
    pub full_pointless: u32,
    /// FULL-USEFUL
    pub full_useful: FixedString<3>,
}
impl std::fmt::Display for Scr {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        write!(f, "{}{}", self.full_pointless, self.full_useful)
    }
}
...
impl Default for ProgramState {
    fn default() -> Self {
        Self {
            num: Default::default(),
            scr: Default::default(),
            full_pointless: Default::default(),
            full_useful: Default::default(),
            return_code: 0,
            tally: 0,
            sort_return: 0,
            cob_crt_status: 0,
