...
fn p__implicit_(state: &mut ProgramState) {
    state.work_udword_1 = format!("{}", 18446744073709551616.000000).cobol_into();
    println!("{}", format!("{}", state.work_udword_1));
    state.work_udword_1 = format!("{}", (format!("{}", format!("{}", state.work_udword_1)).trim().parse::<f64>().unwrap_or(0.0) / format!("{}", format!("{}", 2)).trim().parse::<f64>().unwrap_or(0.0))).cobol_into();
    println!("{}", format!("{}", state.work_udword_1));
    std::process::exit(0);
}
