...
fn p__implicit_(state: &mut ProgramState) {
    println!("{}{}", format!("{}", cobol_fn_trim(format!("{}", state.x))), format!("{}", state.end_display));
    println!("{}{}", format!("{}", cobol_fn_trim(format!("{}", state.x), format!("{}", state.trailing))), format!("{}", state.end_display));
    std::process::exit(0);
}
