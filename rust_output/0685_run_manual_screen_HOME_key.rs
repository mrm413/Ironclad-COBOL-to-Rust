...
fn p__implicit_(state: &mut ProgramState) {
    println!("{}", format!("{}", "Enter 'y' if multiple presses of the HOME key"));
    println!("{}", format!("{}", "go to the beginning of the field and the beginning"));
    println!("{}", format!("{}", "of the characters."));
