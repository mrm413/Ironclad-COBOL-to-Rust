...
fn p__implicit_(state: &mut ProgramState) {
    println!("{}{}{}{}{}{}{}", format!("{}", ""), format!("{}", 135), format!("{}", 151), format!("{}", ""), format!("{}", 195), format!("{}", 194), format!("{}", ""));
    println!("{}{}{}", format!("{}", ""), format!("{}", 135), format!("{}", ""));
    println!("{}{}{}{}{}", format!("{}", ""), format!("{}", 135), format!("{}", state.x), format!("{}", 194), format!("{}", ""));
