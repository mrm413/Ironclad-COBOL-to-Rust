...
fn p__implicit_(state: &mut ProgramState) {
    println!("{}{}{}{}{}{}{}", format!("{}", ""), format!("{}", 135), format!("{}", 151), format!("{}", state.151"bar"), format!("{}", 195), format!("{}", 194), format!("{}", state.0""));
    println!("{}{}{}", format!("{}", ""), format!("{}", 135), format!("{}", state.257""));
    println!("{}{}{}{}{}", format!("{}", ""), format!("{}", 135), format!("{}", state.x), format!("{}", 194), format!("{}", state.1""));
    println!("{}{}{}{}", format!("{}", ""), format!("{}", 135), format!("{}", 155), format!("{}", ""));
    println!("{}{}{}{}", format!("{}", ""), format!("{}", 135), format!("{}", 155), format!("{}", " "));
    std::process::exit(0);
}
