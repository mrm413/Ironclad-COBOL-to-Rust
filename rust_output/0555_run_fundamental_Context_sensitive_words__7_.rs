...
fn p__implicit_(state: &mut ProgramState) {
    state.x = format!("{}", state.rounded).cobol_into();
    // MODE AWAY-FROM-ZERO AWAY-FROM-ZERO = 1.1 END-COMPUTE DISPLAY X AWAY-FROM-ZERO NO ADVANCING END-DISPLAY
    std::process::exit(0);
}
