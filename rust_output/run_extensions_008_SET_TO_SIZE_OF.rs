...
impl Default for Tst2 {
    fn default() -> Self {
        Self {
            _filler_9: std::array::from_fn(|_| Default::default()),
        }
    }
}
impl std::fmt::Display for Tst2 {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        write!(f, "")
    }
}
impl From<&str> for Tst2 {
    fn from(_s: &str) -> Self { Self::default() }
}
impl From<String> for Tst2 {
...
pub struct Filler9 {
    /// T2-1
    pub t2_1: FixedString<11>,
    /// T2-2
    pub t2_2: FixedString<22>,
}
impl std::fmt::Display for Filler9 {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        write!(f, "{}{}", self.t2_1, self.t2_2)
    }
}
...
impl Default for ProgramState {
    fn default() -> Self {
        Self {
            tst: FixedString::from_cobol_str("abcdefghij"),
