...
fn p__implicit_(state: &mut ProgramState) {
    state.x = format!("{}", 10).cobol_into();
    println!("{}", format!("{}", cobol_fn_trim(cobol_fn_exception_status())));
    println!("{}", format!("{}", cobol_fn_trim(cobol_fn_exception_location())));
    println!("{}", format!("{}", cobol_fn_trim(cobol_fn_exception_status())));
    println!("{}", format!("{}", cobol_fn_trim(cobol_fn_exception_location())));
    state.last = " ".to_string().cobol_into();
    // TO OFF DISPLAY FUNCTION TRIM(FUNCTION EXCEPTION-STATUS) DISPLAY FUNCTION TRIM(FUNCTION EXCEPTION-LOCATION)
}
