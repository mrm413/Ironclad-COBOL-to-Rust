...
fn p__implicit_(state: &mut ProgramState) {
    if format!("{}", state.i).trim().parse::<f64>().unwrap_or(0.0) < format!("{}", (format!("{}", format!("{}", state.i)).trim().parse::<f64>().unwrap_or(0.0) + format!("{}", format!("{}", 2)).trim().parse::<f64>().unwrap_or(0.0))).trim().parse::<f64>().unwrap_or(0.0) {
        println!("{}", format!("{}", "OK"));
    }
    std::process::exit(0);
}
