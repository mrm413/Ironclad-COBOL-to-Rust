...
fn p__implicit_(state: &mut ProgramState) {
    println!("{}", format!("{}", state.test_avr));
    println!("{}", format!("{}", state.test_avr_bis));
    println!("{}", format!("{}", state.test_ko));
    println!("{}", format!("{}", state.test_dd));
    println!("{}", format!("{}", state.test_ff));
    std::process::exit(0);
}
