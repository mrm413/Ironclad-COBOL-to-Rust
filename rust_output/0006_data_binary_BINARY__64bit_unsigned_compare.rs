...
pub struct ProgramState {
    ...
    /// WS: BDU-1
    pub bdu_1: FixedString<1>,
    /// WS: BDU-2
    pub bdu_2: FixedString<1>,
    // --- Special registers ---
...
fn p__implicit_(state: &mut ProgramState) {
    state.bdu_1 = format!("{}", 18446744073709551616.000000).cobol_into();
    state.bdu_2 = format!("{}", 18446744073709551616.000000).cobol_into();
    if format!("{}", state.bdu_1).trim() != format!("{}", state.bdu_2).trim() {
        println!("{}", format!("{}", "FAIL"));
    }
    std::process::exit(0);
}
