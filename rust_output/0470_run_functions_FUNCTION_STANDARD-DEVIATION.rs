...
fn p__implicit_(state: &mut ProgramState) {
    state.y = format!("{}", cobol_fn_standard_deviation(&cobol_fn_standard_deviation(&cobol_fn_standard_deviation(&cobol_fn_standard_deviation(&format!("{}", 3), &format!("{}", -14)), &format!("{}", 0)), &format!("{}", 8)), &format!("{}", -3))).cobol_into();
    if format!("{}", state.y).trim() != format!("{}", 7.359348).trim() {
